...
COPY continents FROM '/docker-entrypoint-initdb.d/data/continents.csv' DELIMITER ',' CSV HEADER;
COPY countries FROM '/docker-entrypoint-initdb.d/data/countries.csv' DELIMITER ',' CSV HEADER;
COPY market_mapping FROM '/docker-entrypoint-initdb.d/data/sample-market_mapping.csv' DELIMITER ',' CSV HEADER;
COPY monthly_balance FROM '/docker-entrypoint-initdb.d/data/sample-monthly_balance.csv' DELIMITER ',' CSV HEADER;
COPY monthly_lo FROM '/docker-entrypoint-initdb.d/data/sample-monthly_lo.csv' DELIMITER ',' CSV HEADER;
