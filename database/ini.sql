...
COPY continents FROM 'D:/TFM/database/data/continents.csv' DELIMITER ',' CSV HEADER;
COPY countries FROM 'D:/TFM/database/data/countries.csv' DELIMITER ',' CSV HEADER;
COPY month_calendar FROM 'D:/TFM/database/data/sample-month_calendar.csv' DELIMITER ',' CSV HEADER;
