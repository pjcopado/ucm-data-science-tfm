...
class MonthlyLoModel(Base, UUIDMixIn):
    __tablename__ = "monthly_lo"
    ...
    def __repr__(self) -> str:
        return (
            f"{self.__class__.__name__}(period={self.market}{self.month}, market={self.market}, bu={self.bu}, value={self.value})"
        )
